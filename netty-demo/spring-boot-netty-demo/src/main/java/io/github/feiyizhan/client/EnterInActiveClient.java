...
import io.github.feiyizhan.handler.EnterInActiveHandler;
 ...
 */
public class EnterInActiveClient extends BaseClient<SocketChannel> {

    public EnterInActiveClient(String host, int port) {
        super(host, port);
    }
